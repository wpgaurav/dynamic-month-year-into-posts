...
define( 'DYNAMIC_MONTH_YEAR_INTO_POSTS_VERSION', '1.2.7' );
...
add_shortcode( 'monthyear' , 'rmd_monthyear' );
    ...
    $dateseo101 = strtotime("first day of +1 month");
    $dateseo = date_i18n("F",$dateseo101);
    // params done
    $monthyearseo = ucfirst($dateseo);
    $dtseo = date_i18n("j");
    $yrseo = date_i18n("Y");
    // $nyearseo = $yrseo + 1;
    if($dtseo < 28){
